    ...
    render(props) {
        ...
        return (
            <div className='flex-container'>
                <div className='FlexBarGraph'>
                    <div>
                        <h1 style={{ color: '#8D68EE', textAlign: 'center', paddingTop: '3%' }}> Priority Call Stats{/* Remove Padding if Button moves location */}
                        ...
                        <div style={{ color: 'black', margin: 'auto', padding: 'auto' }}>
                            ...
                            {this.props.toggle ? (
                                <BarGraph
                                    ...
                                    width={$(window).width() > 767 ? 1010 : 410}
                                    height={210}
                                    id="graph"
                                    ...
                                    <BarGraph
                                        data={
                                            $(window).width() > 767 ?
                                                ...
                                                :
                                                [
                                                    [[januaryAL[1], januaryAL[2], januaryAL[3], januaryAL[4]], "Jan 2017"],
                                                    [[februaryAL[1], februaryAL[2], februaryAL[3], februaryAL[4]], "Feb 2017"],
                                                    [[marchAL[1], marchAL[2], marchAL[3], marchAL[4]], "Mar 2017"],
                                                    [[aprilAL[1], aprilAL[2], aprilAL[3], aprilAL[4]], "Apr 2017"],
                                                    [[mayAL[1], mayAL[2], mayAL[3], mayAL[4]], "May 2017"],
                                                    [[juneAL[1], juneAL[2], juneAL[3], juneAL[4]], "Jun 2017"],
                                                    [[julyAL[1], julyAL[2], julyAL[3], julyAL[4]], "Jul 2017"],
                                                    [[augustAL[1], augustAL[2], augustAL[3], augustAL[4]], "Aug 2017"]
                                                ]
                                        }
                                        width={$(window).width() > 767 ? 1010 : 410}
                                        height={210}
                ...
                <div className='FlexLineGraph'>
                    <h1 style={{ color: '#8D68EE', textAlign: 'center', paddingTop: '3%' }}>Incoming Call Stats</h1>
                    ...
                    <div style={{ color: '#4F6472' }}>
                        <LineGraph
                            ...
                            width={$(window).width() > 767 ? 820 : 410}
                            height={210}
                            xAxisLabel={"Time"}
                            yAxisLabel={"Calls"}
                            emptyText={"There is no data. Please start a simulation to display data."}
                            isUTC={false}
                            isXTime={true}
                            timeFormat={$(window).width() > 767 ? "%B %Y" : "%b %Y"}
                            color={['#8D68EE']}
                            style={{ display: 'flex' }}
                        />
                    </div>
